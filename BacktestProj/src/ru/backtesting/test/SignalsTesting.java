...
public class SignalsTesting {
	...
	public static void main(String[] args) {
		...
		MovingAverageIndicatorSignal smaSignalActionDaily = new MovingAverageIndicatorSignal(50, 200, MarketIndicatorType.SMA_IND, TradingTimeFrame.Daily);
		...
		MovingAverageIndicatorSignal smaSignalActionWeekly = new MovingAverageIndicatorSignal(50, 200, MarketIndicatorType.SMA_IND, TradingTimeFrame.Weekly);
		...
		RSIOscillatorSignal rsiOsc = new RSIOscillatorSignal(14, TradingTimeFrame.Daily);
