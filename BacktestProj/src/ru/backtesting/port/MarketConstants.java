...
public class MarketConstants {
	...
	public static final DatePeriodForGraphics shortTermPeriod = new DatePeriodForGraphics(2018, 2020);
	// private static final String BASE_USA_STOCK_INDEX_TICKER = "HYG"; // hight yeald bonds
	
	public static final DatePeriodForGraphics longTermPeriod = new DatePeriodForGraphics(2016, 2020);
}
